...
public class RecyclerProducidAdapter extends BaseQuickAdapter<ProDuctIDItem.DataDTO, QuickViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull QuickViewHolder holder, int i, @Nullable ProDuctIDItem.DataDTO proDuctIDItem) {
        TextView textView = holder.getView(R.id.cpid_name);
        if (proDuctIDItem != null) {
            textView.setText(proDuctIDItem.getProductId());
        }
    }
}
