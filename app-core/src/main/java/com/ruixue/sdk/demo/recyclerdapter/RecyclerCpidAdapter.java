...
public class RecyclerCpidAdapter extends BaseQuickAdapter<CpNameItem, QuickViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull QuickViewHolder holder, int i, @Nullable CpNameItem cpNameItem) {
        TextView textView = holder.getView(R.id.cpid_name);
        if (cpNameItem != null) {
            textView.setText(cpNameItem.Name);
        }
    }
}
